        ...
        <div class="card ">
          ...
          <form method="POST" action="{{ route('picture.update', $picture->id) }}" class="form-horizontal" enctype="multipart/form-data">
            ...
            <div class="row">
                ...
                <div class="col-sm-10">
                  <div class="form-group">
                    <input type="text" name="resolution" class="form-control{{ $errors->has('resolution') ? ' is-invalid' : '' }}" placeholder="1440x960" value="{{ $picture->resolution }}">
                ...
                <div class="fileinput fileinput-new text-center" data-provides="fileinput">
                  ...
                  <div>
                    <span class="btn btn-rose btn-round btn-file btn-sm">
                      ...
                      {{-- <input type="file" name="img" value="{{ asset('storage/' . $picture->img) }}"/> --}}
