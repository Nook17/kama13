                ...
                <tr>
                    <td>
                        ...
                        @foreach ($posts as $post)
                            ...
                            <tr>
                                <td align="center" style="font-size: 30px; font-family: Helvetica, Arial, sans-serif; color: #333333;" class="padding">Witaj <u>{{ $email }}</u></td>
                            </tr>
                            <tr>
                                <td align="center" style="font-size: 20px; font-family: Helvetica, Arial, sans-serif; color: #333333; padding: 30px 0;" class="padding">Zapraszam Cię do lektury nowego artykułu na moim blogu</td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td>
                                    ...
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                        <tr>
                                            <td align="center" style="padding: 20px 0 0 0; font-size: 20px; line-height: 25px; font-family: Helvetica, Arial, sans-serif; color: #666666;" class="padding"><a href="{{ route('post', $post->slug) }}"><strong>{{ $post->title }}</strong></a>
                                            </td>
                                        </tr>
                                    </table>
                                </td>
                            ...
                            <tr>
                                <td>
                                    ...
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                        <tr>
                                            <td align="center" style="padding: 20px 0 0 0; font-size: 16px; line-height: 25px; font-family: Helvetica, Arial, sans-serif; color: #666666; padding-top: 20px;" class="padding">Już wkrótce dostaniesz powiadomienie o nowych artykułach. Pozdrawiam.
                                            </td>
                                        </tr>
                                    </table>
                                </td>
